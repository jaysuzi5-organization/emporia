...
import framework.db
from models.emporia import Base
from api import health, info, emporia
...
app = FastAPI(
    title="Emporia API",
    version="1.0.0",
    openapi_url="/api/v1/emporia/openapi.json",
    docs_url="/api/v1/emporia/docs",
    lifespan=lifespan
)
...
app.include_router(emporia.router, tags=["emporia"])
app.mount("/emporia/test", StaticFiles(directory="static", html=True), name="test")
